    ...
    try {
      ...
      try {
        this._wallet = await connect({
          dAppInfo: {
            name: 'Puzzle Wallet',
            description: 'Aleo Wallet Adapter',
            iconUrl: this.url
          },
          permissions: {
            programIds: {}
