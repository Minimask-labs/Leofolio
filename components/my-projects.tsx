...
import { Calendar, Clock, FileText, CheckCircle, AlertCircle, ChevronDown, ChevronUp } from "lucide-react"
...
export function MyProjects() {
  ...
  const activeProjects = [
    ...
    },
    {
      ...
      progress: 40,
      milestones: [
        { id: 1, title: "Requirements Analysis", status: "completed", dueDate: "2023-06-30" },
        { id: 2, title: "UI/UX Design", status: "completed", dueDate: "2023-07-31" },
        { id: 3, title: "Core Functionality", status: "in-progress", dueDate: "2023-09-15" },
        { id: 4, title: "Wearable Integration", status: "not-started", dueDate: "2023-10-15" },
        { id: 5, title: "Testing & Deployment", status: "not-started", dueDate: "2023-10-30" },
      ],
      updates: [
        {
          id: 1,
  ...
  const completedProjects = [
    {
      ...
      description: "Redesigned the company website with modern design and improved user experience.",
      ...
      progress: 100,
      milestones: [
        { id: 1, title: "Requirements Gathering", status: "completed", dueDate: "2023-03-25" },
        { id: 2, title: "Design Phase", status: "completed", dueDate: "2023-04-20" },
        { id: 3, title: "Development", status: "completed", dueDate: "2023-05-25" },
        { id: 4, title: "Testing & Launch", status: "completed", dueDate: "2023-06-10" },
      ],
      updates: [
        {
          id: 1,
          ...
          role: "Client",
          date: "2023-06-12",
          content: "The website looks fantastic! Thank you for your excellent work.",
          isClient: true,
        },
        {
          id: 2,
