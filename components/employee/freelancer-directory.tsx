    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600">
          Discover freelancers with verified credentials while respecting their
          privacy.
        </p>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        <div className="relative flex-grow">
          ...
          <Input
            placeholder="Search by skills, title, or expertise..."
            className="pl-10"
          />
        </div>
                        ...
                        <div className="md:col-span-1">
                          ...
                          <div className="mt-4">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                handleVerifyCredentials(selectedFreelancer)
                              }
                            >
                              Verify Credentials
                            </Button>
                        ...
                        <div className="md:col-span-2">
                          ...
                          <div className="mt-6">
                            ...
                            <p className="text-sm text-slate-500 italic">
                              Work history is private. The freelancer can
                              generate proofs of experience without revealing
                              client details.
                            </p>
                          </div>
                        </div>
