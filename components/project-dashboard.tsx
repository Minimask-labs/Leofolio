  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">{project.name || project.title}</h1>
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>Update project details, deadlines, and settings.</DialogDescription>
                </DialogHeader>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="overview" className="space-y-6 mt-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between text-sm mb-2">
                  <div>
                    <p className="font-medium text-2xl">{stats.completedMilestones}</p>
                    <p className="text-slate-500">Completed</p>
                  </div>
                  <div>
                    <p className="font-medium text-2xl">{stats.inProgressMilestones}</p>
                    <p className="text-slate-500">In Progress</p>
                  </div>
                  <div>
                    <p className="font-medium text-2xl">
                      {stats.totalMilestones - stats.completedMilestones - stats.inProgressMilestones}
                    </p>
                ...
                <div className="space-y-2">
                  {project.milestones.slice(0, 3).map((milestone: any) => (
                    <div key={milestone.id} className="flex justify-between items-center rounded-md bg-slate-50 p-2">
                ...
                <Button variant="outline" className="w-full mt-2 text-sm" onClick={() => setActiveTab("milestones")}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  {project.freelancers.slice(0, 3).map((freelancer: any, idx: number) => (
                  ...
                  {project.freelancers.length > 3 && (
                    <p className="text-xs text-slate-500 mt-2">+ {project.freelancers.length - 3} more</p>
                  )}
                ...
                <div className="space-y-2 max-h-[150px] overflow-y-auto">
                  {project.updates.slice(0, 3).map((update: any) => (
                    <div key={update.id} className="text-sm">
                      ...
                      <p className="text-xs text-slate-600 truncate">{update.content.substring(0, 60)}...</p>
                    </div>
                  ))}
                </div>
                <Button
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        {project.milestones.find((m: any) => m.status === "in-progress")?.title || "Planning"}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">{new Date(project.deadline).toLocaleDateString()}</p>
                    </div>
                  </div>
          ...
          {project.status === "completed" && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Project performance summary and final stats</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="bg-slate-50 p-4 rounded-lg text-center">
                    <p className="text-3xl font-bold text-purple-600">{project.freelancers.length}</p>
                    <p className="text-sm text-slate-500">Team Members</p>
                  </div>
                  <div className="bg-slate-50 p-4 rounded-lg text-center">
                    <p className="text-3xl font-bold text-amber-600">{project.milestones.length}</p>
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600">
                    This project was completed successfully, meeting all primary objectives and deliverables. The team
                    overcame several challenges including [specific challenges] and delivered high-quality work that
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="text-base font-medium mb-2">Client Feedback</h3>
                    <div className="border rounded-md p-4 bg-slate-50">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <div>
                          <p className="text-sm font-medium">{project.clientContact || "Client"}</p>
                          <p className="text-xs text-slate-500">
                            {new Date(project.completionDate).toLocaleDateString()}
                          </p>
                        </div>
                      ...
                      <p className="text-sm italic">
                        "The team delivered exceptional work on this project. They were responsive, professional, and
                        met all our requirements. I would definitely work with them again."
                      </p>
                    </div>
                  </div>

                  <div>
                    <h3 className="text-base font-medium mb-2">Key Achievements</h3>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500 mt-0.5" />
                        <span>Delivered project on schedule and within budget</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500 mt-0.5" />
                        <span>Implemented all requested features with high quality</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500 mt-0.5" />
                        <span>Maintained excellent communication throughout</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-emerald-500 mt-0.5" />
              ...
              <Dialog>
                ...
                <DialogContent>
                  ...
                  <DialogFooter>
                    <Button
                      variant="outline"
                      onClick={() => setNewMilestone({ title: "", dueDate: "", status: "not-started" })}
                    >
                      Cancel
                    </Button>
        ...
        <TabsContent value="team" className="space-y-6 mt-6">
          <div className="flex items-center justify-between">
            ...
            {userType === "employee" && project.status !== "completed" && (
              <Button size="sm" className="gap-2" onClick={() => setIsAssigningFreelancer(true)}>
                <Plus className="h-4 w-4" />
                Assign Freelancer
              </Button>
            )}
          ...
          {isAssigningFreelancer && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Select a freelancer to add to the project team</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {availableFreelancers
                    .filter((f) => !project.freelancers.some((pf: any) => pf.name === f.name))
                    .map((freelancer) => (
                      <div
                        key={freelancer.id}
              ...
              <CardFooter className="flex justify-between">
                <Button variant="outline" onClick={() => setIsAssigningFreelancer(false)}>
                  Cancel
                </Button>
                <Button onClick={() => setIsAssigningFreelancer(false)}>Done</Button>
              </CardFooter>
            </Card>
          )}
        </TabsContent>
          ...
          <div className="space-y-4">
            <div className="border rounded-md overflow-hidden">
              ...
              <div className="divide-y">
                {[
                  { name: "Project Proposal.pdf", type: "pdf", size: "2.4 MB", date: "2023-07-01" },
                  { name: "Requirements Specification.docx", type: "docx", size: "1.8 MB", date: "2023-07-05" },
                  { name: "Design Assets.zip", type: "zip", size: "15.2 MB", date: "2023-07-15" },
                ].map((file, idx) => (
                  <div key={idx} className="flex items-center justify-between p-3 hover:bg-slate-50">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500">
                          {file.size} • Uploaded on {new Date(file.date).toLocaleDateString()}
                        </p>
                      </div>
                    </div>
            ...
            <div className="border rounded-md overflow-hidden">
              ...
              <div className="divide-y">
                {[
                  { name: "Final Presentation.pptx", type: "pptx", size: "5.7 MB", date: "2023-09-20" },
                  { name: "Source Code.zip", type: "zip", size: "28.3 MB", date: "2023-09-25" },
                ].map((file, idx) => (
                  <div key={idx} className="flex items-center justify-between p-3 hover:bg-slate-50">
                    <div className="flex items-center gap-3">
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-lg font-medium text-amber-800">Project Completed Successfully!</h3>
                <p className="text-amber-700">
                  This project has been completed and approved. A certificate of completion is available.
                </p>
              </div>
              <Button className="bg-amber-600 hover:bg-amber-700">View Certificate</Button>
            </div>
          </CardContent>
        </Card>
      )}
