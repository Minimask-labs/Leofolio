    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-600">
          Discover projects from companies looking for freelancers with your
          skills.
        </p>
      </div>
                      ...
                      <div className="py-4">
                        ...
                        <div className="bg-slate-50 p-4 rounded-lg">
                          ...
                          <ul className="text-sm text-slate-600 space-y-1 list-disc pl-5 mb-2">
                            <li>
                              Your application will be sent privately to the
                              client
                            </li>
                            <li>
                              You can choose which credentials to share as
                              verifiable proofs
                            </li>
                            <li>
                              Your contact information remains private until you
                              accept an offer
                            </li>
                          </ul>
                        </div>
