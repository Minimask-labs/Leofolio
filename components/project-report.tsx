      ...
      <Card className="bg-gradient-to-r from-blue-50 to-blue-100 border-blue-200">
        <CardContent className="p-6">
          <div className="flex flex-col md:flex-row items-center gap-4">
            <div className="bg-blue-100 p-4 rounded-full border-4 border-white">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Successfully delivered all deliverables by the agreed
                        deadline.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Implemented all project requirements with high quality.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Received excellent feedback from the client.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Provided detailed documentation for all project
                        components.
                      </p>
                    </div>
                  </li>
                ...
                <div className="p-4 bg-slate-50 rounded-lg border">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600">
                      The project was completed on time and within budget. The
                      development team was very communicative throughout the
                      process, and they were quick to address any concerns we
                      had. The final product exceeded our expectations.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="divide-y">
                    {[
                      ...
                      },
                      {
                        ...
                        rating: 5,
                        comment: 'Delivered high-quality code and design'
                      },
                      {
                        category: 'Timeliness',
                        rating: 4.5,
                        comment: 'Met all deadlines with minor adjustments'
                      },
                      {
                        category: 'Problem Solving',
                        rating: 5,
                        comment: 'Creative solutions to complex requirements'
                      },
                      {
                        category: 'Documentation',
                        rating: 4.5,
                        comment: 'Comprehensive and well-organized'
                      }
                    ].map((item, idx) => (
              ...
              <div className="space-y-4">
                  ...
                  <div className="border rounded-md p-4">
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Earlier integration testing could have identified
                          issues sooner
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <AlertCircle className="h-4 w-4 text-amber-500 mt-0.5" />
                        <span>
                          More detailed initial planning for complex features
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <AlertCircle className="h-4 w-4 text-amber-500 mt-0.5" />
                        <span>
                          Additional time for refactoring and optimization
                        </span>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-sm text-blue-700 mb-2">
                    This project provided valuable insights that will benefit
                    future projects:
                  </p>
                  <ul className="space-y-2 text-sm text-blue-700">
                    ...
                    <li className="flex items-start gap-2">
                      <Award className="h-4 w-4 text-blue-600 mt-0.5" />
                      <span>
                        Thorough documentation saves time in the long run
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <Card
                      key={idx}
                      className="bg-gradient-to-b from-amber-50 to-white border-amber-200"
                    >
